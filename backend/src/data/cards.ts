...
export const MALOSOS_CARDS: Card[] = [
  // --- FASE / PREPARACION (6) ---
  {
    id: 'M01',
...
export const BUENOSOS_CARDS: Card[] = [
  // --- PREVENCION (6) ---
  {
    id: 'B01',
...
export const ALL_CARDS: Card[] = [...MALOSOS_CARDS, ...BUENOSOS_CARDS, ...EVENT_CARDS];

export const MALOSOS_DECK: Card[] = [...MALOSOS_CARDS];
export const BUENOSOS_DECK: Card[] = [...BUENOSOS_CARDS];
export const EVENT_DECK: Card[] = [...EVENT_CARDS];

const CARD_MAP: Map<string, Card> = new Map(ALL_CARDS.map((c) => [c.id, c]));
